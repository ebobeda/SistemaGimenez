...
public class JDlgClientePesquisar_ebg extends javax.swing.JDialog {
    ...
    ClienteControle_ebg clienteControle_ebg;
    /**
     * Creates new form JDlgClientePesquisar
     */
    public JDlgClientePesquisar_ebg(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Consulta de usuários");
        clienteControle_ebg = new ClienteControle_ebg();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgClientePesquisar_ebg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgClientePesquisar_ebg dialog = new JDlgClientePesquisar_ebg(new javax.swing.JFrame(), true);
...
public void setTelaAnterior(JDlgCliente_ebg jDlgCliente_ebg) {
        this.jDlgCliente_ebg = jDlgCliente_ebg;
    }
}
