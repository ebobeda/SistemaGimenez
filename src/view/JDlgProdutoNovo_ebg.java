 ...
 * @author user
 */
public class JDlgProdutoNovo_ebg extends javax.swing.JDialog {
    ...
    public JDlgProdutoNovo_ebg(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Inclusão");
    ...
    private void jBtnExcluir_ebgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnExcluir_ebgActionPerformed
        // TODO add your handling code here:
        if (Util_ebg.perguntar("Deseja excluir este usuario?") == true){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgProdutoNovo_ebg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgProdutoNovo_ebg dialog = new JDlgProdutoNovo_ebg(new javax.swing.JFrame(), true);
